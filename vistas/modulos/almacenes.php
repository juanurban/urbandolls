            ...
            echo '<tr>
                    ...
                    <td>
                      ...
                      <div class="btn-group">
                        ...
                        <button class="btn btn-warning btnEditarAlmacen" data-toggle="modal" data-target="#modalEditarAlmacen" idAlmacen="'.$value["id"].'"><i class="fa fa-pencil"></i></button>
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="nuevoAlmacen" placeholder="Ingresar nombre" required>
